...
from test.Pages.BayadPage import Bayad
...
def release5_tc039(driver, ts_id, username, password):
    home = Home()
    home.click_home_login(driver)
    login = Login()
    login.set_username(driver, username)
    ...
    login.click_allow(driver)
    overview = Overview()
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC039 Step 1.png')
    overview.swipe_down(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC039 Step 1b.png')
...
def release5_tc096(driver, ts_id, username, password, card_number, cvv, expiry, first_name, last_name, passkey):
    home = Home()
    home.click_home_login(driver)
    login = Login()
    login.set_username(driver, username)
    ...
    overview.click_kebab_menu(driver)
    overview.click_bills_payments(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC096 Step 1.png')
    billspayments = BillsPayments()
    billspayments.click_payment_bill(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC096 Step 2.png')
    billspayments.click_pay_now(driver)
    billspayments.click_undetected_prompt(driver)
    billspayments.click_next(driver)
    billspayments.click_undetected_prompt(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC096 Step 3.png')
    billspayments.click_proceed(driver)
    time.sleep(10)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC096 Step 4.png')
    bayad = Bayad()
    ...
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC096 Step 5.png')
    bayad.swipe_left(driver)
    bayad.swipe_down(driver)
    bayad.click_pay(driver)
    time.sleep(10)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC096 Step 6.png')
    bayad.set_passkey(driver, passkey)
    bayad.click_submit(driver)
    time.sleep(10)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC096 Step 6b.png')
    #bayad.click_view_details(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC096 Step 7.png')
    bayad.click_back_merchant(driver)
    time.sleep(10)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC096 Step 8.png')
    bayad.click_view_pdf(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC096 Step 9.png')

def release5_tc099(driver, ts_id, username, password, card_number, cvv, expiry, first_name, last_name, passkey):
    home = Home()
    home.click_home_login(driver)
    login = Login()
    login.set_username(driver, username)
    ...
    overview.click_kebab_menu(driver)
    overview.click_bills_payments(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC099 Step 1.png')
    billspayments = BillsPayments()
    billspayments.click_pay_now(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC099 Step 2.png')
    billspayments.click_next(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC099 Step 2b.png')
    billspayments.click_proceed(driver)
    time.sleep(10)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC099 Step 3.png')
    bayad = Bayad()
    bayad.click_card(driver)
    bayad.swipe_down(driver)
    bayad.set_card_number(driver, card_number)
    ...
    bayad.set_first_name(driver, first_name)
    bayad.set_last_name(driver, last_name)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC099 Step 4.png')
    bayad.swipe_left(driver)
    bayad.swipe_down(driver)
    bayad.click_pay(driver)
    time.sleep(10)
    ...
    time.sleep(10)
    bayad.click_view_details(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC099 Step 4b.png')
    bayad.click_back_merchant(driver)
    time.sleep(10)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC099 Step 5.png')


def release5_tc100(driver, ts_id, username, password, card_number, cvv, expiry, first_name, last_name, passkey):
    home = Home()
    home.click_home_login(driver)
    login = Login()
    login.set_username(driver, username)
    ...
    overview.click_kebab_menu(driver)
    overview.click_bills_payments(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC100 Step 1.png')
    billspayments = BillsPayments()
    billspayments.click_pay_now(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC100 Step 2.png')
    billspayments.click_next(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC100 Step 2b.png')
    billspayments.click_proceed(driver)
    time.sleep(10)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC100 Step 3.png')
    bayad = Bayad()
    bayad.click_card(driver)
    bayad.swipe_down(driver)
    bayad.set_card_number(driver, card_number)
    ...
    bayad.set_first_name(driver, first_name)
    bayad.set_last_name(driver, last_name)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC100 Step 4.png')
    bayad.swipe_left(driver)
    bayad.swipe_down(driver)
    bayad.click_pay(driver)
    time.sleep(10)
    ...
    time.sleep(10)
    bayad.click_view_details(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC100 Step 4b.png')
    bayad.click_back_merchant(driver)
    time.sleep(10)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC100 Step 5.png')


def release5_tc101(driver, ts_id, username, password):
    home = Home()
    home.click_home_login(driver)
    login = Login()
    login.set_username(driver, username)
    ...
    overview.click_kebab_menu(driver)
    overview.click_bills_payments(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC101 Step 1.png')
    billspayments = BillsPayments()
    billspayments.click_pay_now(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC101 Step 2.png')
    billspayments.click_next(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC101 Step 2b.png')
    billspayments.click_proceed(driver)
    time.sleep(10)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC101 Step 3.png')
    bayad = Bayad()
    bayad.swipe_left(driver)
    driver.save_screenshot(screenshot_folder + f'{module}/{ts_id}/TC101 Step 4.png')
